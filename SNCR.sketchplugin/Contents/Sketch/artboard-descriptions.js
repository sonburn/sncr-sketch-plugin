...
var set = function(context) {
	com.sncr.artboardDescriptions.set(context);
}

var link = function(context) {
	com.sncr.artboardDescriptions.link(context);
}

var unlink = function(context) {
	com.sncr.artboardDescriptions.unlink(context);
}

var select = function(context) {
	com.sncr.artboardDescriptions.select(context);
}
