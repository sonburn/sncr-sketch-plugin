...
var add = function(context) {
	com.sncr.sectionTitles.addNew(context);
}

var link = function(context) {
	com.sncr.sectionTitles.linkSelected(context);
}

var select = function(context) {
	com.sncr.sectionTitles.selectAllOnPage(context);
}

var unlink = function(context) {
	com.sncr.sectionTitles.unlinkSelected(context);
}
