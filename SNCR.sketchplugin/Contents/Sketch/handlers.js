...
var sectionsUpdate = function(context) {
	sncr.init(context,"sections-update");
}

var sectionsSettings = function(context) {
	sncr.init(context,"sections-settings");
}

var titlesCreate = function(context) {
	sncr.init(context,"titles-create");
}

var titlesInclude = function(context) {
	sncr.init(context,"titles-include");
}

var titlesPreclude = function(context) {
	sncr.init(context,"titles-preclude");
}
...
var wireframesAdd = function(context) {
	sncr.init(context,"wireframes-add");
}

var wireframesInclude = function(context) {
	sncr.init(context,"wireframes-include");
}

var wireframesPreclude = function(context) {
	sncr.init(context,"wireframes-preclude");
}
